...
`class User:<br>
    def __init__(self, nome_usuario, quantidade_pts=0, num_perg=0, resp_cliente=None):<br>
        self.nome_usuario = nome_usuario<br>
        self.quantidade_pts = quantidade_pts<br>
        self.num_perg = num_perg<br>
